(function exposeExternalMediaCatalog(root) {
  root.LOCAL_AI_EXTERNAL_MEDIA = {
    ...
    video: {
      'ltx-video': { kind: 'video', url: 'https://github.com/user-attachments/assets/4414adc0-086c-43de-b367-9362eeb20228', poster: '/images/external-media/video/ltx-video.jpg', alt: 'Official LTX 2.5 synchronized audio and video example', sourceLabel: 'LTX 2.5 official repository', sourceUrl: 'https://github.com/Lightricks/LTX-2' },
      'minimax-h3': { kind: 'video', url: 'https://raw.githubusercontent.com/MiniMax-AI/MiniMax-H3/main/assets/t2va.mp4', poster: '/images/external-media/video/minimax-h3.jpg', alt: 'Official MiniMax H3 text-to-audio-video example', sourceLabel: 'MiniMax H3 official repository', sourceUrl: 'https://github.com/MiniMax-AI/MiniMax-H3' },
      'hunyuanvideo-1.5': { kind: 'video', url: 'https://github.com/user-attachments/assets/d45ec78e-ea40-47f1-8d4d-f4d9a0682e2d', poster: '/images/external-media/video/hunyuanvideo-1.5.jpg', alt: 'Official HunyuanVideo 1.5 video example', sourceLabel: 'HunyuanVideo 1.5 official repository', sourceUrl: 'https://github.com/Tencent-Hunyuan/HunyuanVideo-1.5' },
      ...
      'wan2.2-ti2v-5b': { kind: 'video', url: 'https://github.com/user-attachments/assets/b63bfa58-d5d7-4de6-a1a2-98970b06d9a7', poster: '/images/external-media/video/wan2.2-ti2v-5b.jpg', alt: 'Official Wan2.2 video example', sourceLabel: 'Wan2.2 official repository', sourceUrl: 'https://github.com/Wan-Video/Wan2.2' },
      'mochi-1': { kind: 'video', url: 'https://github.com/user-attachments/assets/4d268d02-906d-4cb0-87cc-f467f1497108', poster: '/images/external-media/video/mochi-1.jpg', alt: 'Official Mochi 1 video example', sourceLabel: 'Genmo models official repository', sourceUrl: 'https://github.com/genmoai/models' },
