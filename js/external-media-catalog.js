(function exposeExternalMediaCatalog(root) {
  root.LOCAL_AI_EXTERNAL_MEDIA = {
    ...
    video: {
      'ltx-video': { kind: 'video', url: 'https://github.com/user-attachments/assets/4414adc0-086c-43de-b367-9362eeb20228', poster: '/images/external-media/video/ltx-video.jpg', uploadDate: '2026-01-06T07:17:11+02:00', alt: 'Official LTX 2.5 synchronized audio and video example', sourceLabel: 'LTX 2.5 official repository', sourceUrl: 'https://github.com/Lightricks/LTX-2' },
      'minimax-h3': { kind: 'video', url: 'https://raw.githubusercontent.com/MiniMax-AI/MiniMax-H3/main/assets/t2va.mp4', poster: '/images/external-media/video/minimax-h3.jpg', uploadDate: '2026-08-05T20:13:21+08:00', alt: 'Official MiniMax H3 text-to-audio-video example', sourceLabel: 'MiniMax H3 official repository', sourceUrl: 'https://github.com/MiniMax-AI/MiniMax-H3' },
      'hunyuanvideo-1.5': { kind: 'video', url: 'https://github.com/user-attachments/assets/d45ec78e-ea40-47f1-8d4d-f4d9a0682e2d', poster: '/images/external-media/video/hunyuanvideo-1.5.jpg', uploadDate: '2025-11-20T06:15:42Z', alt: 'Official HunyuanVideo 1.5 video example', sourceLabel: 'HunyuanVideo 1.5 official repository', sourceUrl: 'https://github.com/Tencent-Hunyuan/HunyuanVideo-1.5' },
      'cogvideox-2b': { kind: 'video', url: 'https://github.com/user-attachments/assets/ea3af39a-3160-4999-90ec-2f7863c5b0e9', poster: '/images/external-media/video/cogvideox-2b.jpg', uploadDate: '2024-08-05T18:12:51Z', alt: 'Official CogVideoX 2B video example', sourceLabel: 'CogVideo official repository', sourceUrl: 'https://github.com/zai-org/CogVideo' },
      'wan2.2-ti2v-5b': { kind: 'video', url: 'https://github.com/user-attachments/assets/b63bfa58-d5d7-4de6-a1a2-98970b06d9a7', poster: '/images/external-media/video/wan2.2-ti2v-5b.jpg', uploadDate: '2025-07-28T20:42:39+08:00', alt: 'Official Wan2.2 video example', sourceLabel: 'Wan2.2 official repository', sourceUrl: 'https://github.com/Wan-Video/Wan2.2' },
      'mochi-1': { kind: 'video', url: 'https://github.com/user-attachments/assets/4d268d02-906d-4cb0-87cc-f467f1497108', poster: '/images/external-media/video/mochi-1.jpg', uploadDate: '2024-10-22T10:31:20Z', alt: 'Official Mochi 1 video example', sourceLabel: 'Genmo models official repository', sourceUrl: 'https://github.com/genmoai/models' },
      'wan2.1-t2v-1.3b': { kind: 'video', url: 'https://cloud.video.taobao.com/vod/Jth64Y7wNoPcJki_Bo1ZJTDBvNjsgjlVKsNs05Fqfps.mp4', poster: '/images/external-media/video/wan2.1-t2v-1.3b.jpg', uploadDate: '2025-02-25T22:54:11+08:00', alt: 'Official Wan2.1 text-to-video demo', sourceLabel: 'Wan2.1 T2V official model card', sourceUrl: 'https://huggingface.co/Wan-AI/Wan2.1-T2V-1.3B-Diffusers' },
