...
(() => {
  ...
  document.addEventListener('click', event => {
    ...
    const props={};
    for(const key of ['family','market','country','source','product','match','attribution','selected_market','destination_host','tag'])props[key]=link.getAttribute('data-fast-goal-'+key)||'';
