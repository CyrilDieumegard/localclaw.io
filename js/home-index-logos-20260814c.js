...
window.HOME_INDEX_LOGOS = {
  ...
  speech: {
    ...
    espeak: 'github',
    f5: 'swivid-avatar',
    fastslm: 'huggingface-avatar',
    fish: 'fishaudio',
    firered: 'huggingface-avatar',
    'gigachat-audio': 'huggingface-avatar',
