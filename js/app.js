        ...
        container.innerHTML = `
            ...
            <section id="fresh-local-ai" aria-label="Recently verified local AI models" class="mb-20">
                <div class="rounded-2xl border border-claw-primary/20 bg-[radial-gradient(ellipse_at_top_left,rgba(255,69,58,0.10),transparent_42%),rgba(255,255,255,0.02)] p-6 sm:p-8">
                    ...
                    <div class="grid gap-3 md:grid-cols-3">
                        <a href="/models/granite4.2-8b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="granite4.2-8b" class="rounded-xl border border-claw-primary/30 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Aug 26, 2026 · Apache reasoning</p><h3 class="mt-3 text-lg font-display font-bold text-white">Granite 4.2 8B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">IBM Apache 2.0 instruct model with 128K context, tool calling and an 8 GB local fit.</p></a>
                        <a href="/models/granite4.2-30b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="granite4.2-30b" class="rounded-xl border border-white/10 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Aug 26, 2026 · Workstation Granite</p><h3 class="mt-3 text-lg font-display font-bold text-white">Granite 4.2 30B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Permissive 30B-class Granite model for RAG, coding and reasoning on 32 GB+ machines.</p></a>
                        <a href="/models/ornith-1-5-9b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="ornith-1-5-9b" class="rounded-xl border border-white/10 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Aug 18, 2026 · Agentic coding</p><h3 class="mt-3 text-lg font-display font-bold text-white">Ornith-1.5-9B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">MIT reasoning model with official Q4_K_M GGUF, 262K context and a 16 GB local fit.</p></a>
                    </div>
                </div>
            </section>
