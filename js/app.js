        ...
        container.innerHTML = `
            ...
            <section id="fresh-local-ai" aria-label="Recently verified local AI models" class="mb-20">
                <div class="rounded-2xl border border-claw-primary/20 bg-[radial-gradient(ellipse_at_top_left,rgba(255,69,58,0.10),transparent_42%),rgba(255,255,255,0.02)] p-6 sm:p-8">
                    ...
                    <div class="grid gap-3 md:grid-cols-3">
                        <a href="/models/lfm2-5-vl-3b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="lfm2-5-vl-3b" class="rounded-xl border border-claw-primary/30 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Aug 11, 2026 · Edge VLM</p><h3 class="mt-3 text-lg font-display font-bold text-white">LFM2.5-VL-3B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Liquid AI vision model with official Q4_K_M GGUF, mmproj file and 8 GB local fit.</p></a>
                        <a href="/models/ling-3.0-tiny" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="ling-3.0-tiny" class="rounded-xl border border-white/10 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Aug 10, 2026 · Tiny MoE</p><h3 class="mt-3 text-lg font-display font-bold text-white">Ling-3.0-tiny</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">MIT hybrid-reasoning MoE with 131K context and a Q4_K_M GGUF for 8 GB local machines.</p></a>
                        <a href="/models/muse-glimmer-30b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="muse-glimmer-30b" class="rounded-xl border border-white/10 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Aug 9, 2026 · Agentic VLM</p><h3 class="mt-3 text-lg font-display font-bold text-white">Muse Glimmer 30B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Apache 2.0 local agent model with official 17 GB GGUF, vision input and 131K context.</p></a>
                    </div>
                </div>
            </section>
