        ...
        container.innerHTML = `
            ...
            <section id="fresh-local-ai" aria-label="Recently verified local AI models" class="mb-20">
                <div class="rounded-2xl border border-claw-primary/20 bg-[radial-gradient(ellipse_at_top_left,rgba(255,69,58,0.10),transparent_42%),rgba(255,255,255,0.02)] p-6 sm:p-8">
                    ...
                    <div class="grid gap-3 md:grid-cols-3">
                        <a href="/models/muse-glimmer-30b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="muse-glimmer-30b" class="rounded-xl border border-claw-primary/30 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Aug 9, 2026 · Agentic VLM</p><h3 class="mt-3 text-lg font-display font-bold text-white">Muse Glimmer 30B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Apache 2.0 local agent model with official 17 GB GGUF, vision input and 131K context.</p></a>
                        <a href="/models/qwen3.8-27b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="qwen3.8-27b" class="rounded-xl border border-white/10 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Aug 5, 2026 · Dense VLM</p><h3 class="mt-3 text-lg font-display font-bold text-white">Qwen3.8-27B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Official Apache 2.0 Qwen release with 262K context and Q4_K_M GGUF for 32 GB workstations.</p></a>
                        <a href="/models/deepseek-v4-flash-0731" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="deepseek-v4-flash-0731" class="rounded-xl border border-white/10 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Jul 31, 2026 · Coding MoE</p><h3 class="mt-3 text-lg font-display font-bold text-white">DeepSeek V4 Flash 0731</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Official MIT coding release with a practical Unsloth GGUF path for large local workstations.</p></a>
                    </div>
                </div>
            </section>
