        ...
        container.innerHTML = `
            ...
            <section id="fresh-local-ai" aria-label="Recently verified local AI models" class="mb-20">
                <div class="rounded-2xl border border-claw-primary/20 bg-[radial-gradient(ellipse_at_top_left,rgba(255,69,58,0.10),transparent_42%),rgba(255,255,255,0.02)] p-6 sm:p-8">
                    ...
                    <div class="grid gap-3 md:grid-cols-3">
                        <a href="/models/minicpm5-2b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="minicpm5-2b" class="rounded-xl border border-claw-primary/30 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Sep 8, 2026 · On-device 2B</p><h3 class="mt-3 text-lg font-display font-bold text-white">MiniCPM5 2B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Apache 2.0 OpenBMB model with 131K context, Q4_K_M GGUF and Ollama paths.</p></a>
                        <a href="/models/spark-x2-5-4b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="spark-x2-5-4b" class="rounded-xl border border-white/10 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Sep 2, 2026 · Long-context 4B</p><h3 class="mt-3 text-lg font-display font-bold text-white">Spark-X2.5-4B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Apache 2.0 compact agent model with 1M context and official GGUF local paths.</p></a>
