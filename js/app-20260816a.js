        ...
        container.innerHTML = `
            ...
            <section id="fresh-local-ai" aria-label="Recently verified local AI models" class="mb-20">
                <div class="rounded-2xl border border-claw-primary/20 bg-[radial-gradient(ellipse_at_top_left,rgba(255,69,58,0.10),transparent_42%),rgba(255,255,255,0.02)] p-6 sm:p-8">
                    ...
                    <div class="grid gap-3 md:grid-cols-3">
                        <a href="/models/spark-x2-5-4b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="spark-x2-5-4b" class="rounded-xl border border-claw-primary/30 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Sep 2, 2026 · Long-context 4B</p><h3 class="mt-3 text-lg font-display font-bold text-white">Spark-X2.5-4B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Apache 2.0 compact agent model with 1M context and official GGUF local paths.</p></a>
                        <a href="/models/spark-x2-5-1-7b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="spark-x2-5-1-7b" class="rounded-xl border border-white/10 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Sep 2, 2026 · Lightweight Spark</p><h3 class="mt-3 text-lg font-display font-bold text-white">Spark-X2.5-1.7B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Tiny Apache 2.0 Spark release for chat, coding and long-context smoke tests.</p></a>
                        <a href="/models/ibnsina-1.5b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="ibnsina-1.5b" class="rounded-xl border border-white/10 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Sep 1, 2026 · Persian-first</p><h3 class="mt-3 text-lg font-display font-bold text-white">IbnSina-1.5B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Apache 2.0 Persian local chat model with Q4 GGUF, Ollama and LM Studio paths.</p></a>
                    </div>
                </div>
            </section>
