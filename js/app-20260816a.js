            ...
            <section id="fresh-local-ai" aria-label="Recently verified local AI models" class="mb-20">
                <div class="rounded-2xl border border-claw-primary/20 bg-[radial-gradient(ellipse_at_top_left,rgba(255,69,58,0.10),transparent_42%),rgba(255,255,255,0.02)] p-6 sm:p-8">
                    ...
                    <div class="grid gap-3 md:grid-cols-3">
                        ...
                        <a href="/models/lfm2-5-vl-3b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="lfm2-5-vl-3b" class="rounded-xl border border-white/10 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Aug 11, 2026 · Edge VLM</p><h3 class="mt-3 text-lg font-display font-bold text-white">LFM2.5-VL-3B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Liquid AI vision model with official Q4_K_M GGUF, mmproj file and 8 GB local fit.</p></a>
                    </div>
                </div>
            </section>
