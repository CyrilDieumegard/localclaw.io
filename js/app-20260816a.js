        ...
        container.innerHTML = `
            ...
            <section id="fresh-local-ai" aria-label="Recently verified local AI models" class="mb-20">
                <div class="rounded-2xl border border-claw-primary/20 bg-[radial-gradient(ellipse_at_top_left,rgba(255,69,58,0.10),transparent_42%),rgba(255,255,255,0.02)] p-6 sm:p-8">
                    ...
                    <div class="grid gap-3 md:grid-cols-3">
                        <a href="/models/ornith-1-5-9b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="ornith-1-5-9b" class="rounded-xl border border-claw-primary/30 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Aug 18, 2026 · Agentic coding</p><h3 class="mt-3 text-lg font-display font-bold text-white">Ornith-1.5-9B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">MIT reasoning model with official Q4_K_M GGUF, 262K context and a 16 GB local fit.</p></a>
                        <a href="/models/ornith-1-5-35b-a3b" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="ornith-1-5-35b-a3b" class="rounded-xl border border-white/10 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Aug 18, 2026 · Workstation MoE</p><h3 class="mt-3 text-lg font-display font-bold text-white">Ornith-1.5-35B-A3B</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Official 21.7 GB Q4_K_M GGUF for 48 GB+ local coding-agent workstations.</p></a>
                        <a href="/models/llm-jp-4-33b-thinking" data-fast-goal="model_open" data-fast-goal-source="home_recent" data-fast-goal-model="llm-jp-4-33b-thinking" class="rounded-xl border border-white/10 bg-black/35 p-5 transition-all hover:-translate-y-0.5 hover:border-claw-primary"><p class="text-[10px] font-mono font-bold uppercase tracking-[0.18em] text-claw-primary">Aug 14, 2026 · Japanese reasoning</p><h3 class="mt-3 text-lg font-display font-bold text-white">LLM-jp-4 33B Thinking</h3><p class="mt-2 text-xs leading-relaxed text-claw-muted">Apache 2.0 reasoning model with official Q4_K_M GGUF and a 64 GB local workstation fit.</p></a>
                    </div>
                </div>
            </section>
