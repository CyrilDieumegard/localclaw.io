...
# Generated for: macOS · 16GB RAM · Everything
...
echo -e "${CYAN}║  Optimized for: macOS · 16GB · Everything     ║${NC}"
echo -e "${CYAN}╚════════════════════════════════════════════════╝${NC}"
echo ""
...
echo -e "${YELLOW}[4/6]${NC} Downloading Phi-4 14B..."
...
# Context window: 8192 tokens (optimized for 16GB RAM)
echo -e "${YELLOW}  → Context window: 8192 tokens (optimal for 16GB)${NC}"
...
echo -e "${GREEN}║     • Context: 8192 tokens                    ║${NC}"
