...
${hasVisualExamples ? '<script src="/js/external-media-catalog.js?v=20260816g"></script><script src="/js/external-media.js?v=20260816d"></script>' : ''}<script src="/js/local-ai-catalog.js?v=20260816g"></script><script src="/js/local-ai-catalog-app.js?v=20260816e"></script></body></html>`;
}
...
</div></main>${footer()}${hasVisualExample ? '<script src="/js/external-media-catalog.js?v=20260816g"></script><script src="/js/external-media.js?v=20260816d"></script>' : ''}</body></html>`;
}
