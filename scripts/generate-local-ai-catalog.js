...
function landingPage(key, config) {
  ...
  return `<!DOCTYPE html>
<html lang="en" class="light"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="theme-color" content="#faf9f6"><meta name="color-scheme" content="light">
  ...
  ${siteNavAssets()}<link rel="stylesheet" href="/css/local-ai-catalog.css?v=20260822a"><link rel="stylesheet" href="/css/community-ratings-20260802a.css?v=20260822a">${hasVisualExamples ? '<link rel="stylesheet" href="/css/external-media.css?v=20260822a">' : ''}${tracking()}<script type="application/ld+json">${JSON.stringify(schema)}</script>
...
${externalMediaScripts}<script src="/js/local-ai-catalog.js?v=20260821b"></script><script src="/js/local-ai-catalog-app.js?v=20260816f"></script><script src="/js/community-ratings-20260802a.js?v=20260803a"></script></body></html>`;
}
...
function detailPage(model) {
  ...
  return `<!DOCTYPE html><html lang="en" class="light"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="theme-color" content="#faf9f6"><meta name="color-scheme" content="light">
