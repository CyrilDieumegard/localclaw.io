...
const { installChoiceStyles, multimodalInstallPicker, runtimeLaunchAssistStyles } = require('./install-choice-ui');
...
function landingPage(key, config) {
  ...
  return `<!DOCTYPE html>
<html class="light" lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  ${siteNavAssets()}<link rel="stylesheet" href="/css/local-ai-catalog.css?v=20260822b"><link rel="stylesheet" href="/css/community-ratings-20260802a.css?v=20260822a">${hasVisualExamples ? '<link rel="stylesheet" href="/css/external-media.css?v=20260822a">' : ''}${tracking()}<script type="application/ld+json">${JSON.stringify(schema)}</script>
...
${externalMediaScripts}<script src="/js/local-ai-catalog-20260824a.js?v=20260917video"></script><script src="/js/local-ai-catalog-app.js?v=20260816f"></script><script src="/js/community-ratings-20260802a.js?v=20260803a"></script></body></html>`;
}
...
function detailPage(model) {
  ...
  if (model.category === 'video' && mediaEntry && mediaEntry.kind === 'video') {
    ...
    schema['@graph'].push({
      '@type': 'VideoObject',
      name: mediaEntry.title || `${model.name} official video example`,
  ...
  return `<!DOCTYPE html><html class="light" lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@500;600;700&display=swap" rel="stylesheet">${siteNavAssets()}<link rel="stylesheet" href="/css/local-ai-catalog.css?v=20260822b"><link rel="stylesheet" href="/css/community-ratings-20260802a.css?v=20260822a">${hasVisualExample ? '<link rel="stylesheet" href="/css/external-media.css?v=20260822a">' : ''}${tracking()}<style>${installChoiceStyles}${installPickerStyles}</style><script type="application/ld+json">${JSON.stringify(schema)}</script>
