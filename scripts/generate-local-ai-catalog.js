...
${hasVisualExamples ? '<script src="/js/external-media-catalog.js?v=20260816a"></script><script src="/js/external-media.js?v=20260816a"></script>' : ''}<script src="/js/local-ai-catalog.js?v=20260816b"></script><script src="/js/local-ai-catalog-app.js?v=20260816c"></script></body></html>`;
}
...
</div></main>${footer()}${hasVisualExample ? '<script src="/js/external-media-catalog.js?v=20260816a"></script><script src="/js/external-media.js?v=20260816a"></script>' : ''}</body></html>`;
}
