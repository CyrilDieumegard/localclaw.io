...
if (uniqueLocalModels.length !== 236) errors.push(`Local LLM route count is ${uniqueLocalModels.length}, expected 236 canonical routes`);
if (indexableLocalModels.length !== 230) errors.push(`Indexable local LLM count is ${indexableLocalModels.length}, expected 230`);
...
if (fs.readdirSync(path.join(ROOT, 'models')).filter(file => file.endsWith('.html')).length !== 238) errors.push('models/ must contain 238 HTML files');
...
const expectedLatestIds = ['spark-x2-5-4b', 'spark-x2-5-1-7b', 'ibnsina-1.5b', 'k2-horizon-0-9b', 'k2-horizon-mova-36b-a4b', 'deepseek-v4-flash-vision-exp', 'granite4.2-8b', 'granite4.2-30b', 'granite4.2-3b', 'glm-5.3-flash', 'ornith-1-5-9b', 'ornith-1-5-35b-a3b'];
...
if (!index.includes('js/data.js?v=20260907a') || !index.includes('js/app-20260816a.js?v=20260907a')) {
...
const expectedHfStateCounts = {publicGguf: 190, publicModelCard: 40, gated: 4, unavailable: 6};
