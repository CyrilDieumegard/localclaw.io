...
if (models.length !== 82 || localModels.length !== 79 || remoteModels.length !== 2 || unverifiedModels.length !== 1 || unverifiedModels[0]?.id !== 'xtts-v3') {
...
if (!renderedIndex.includes('79<small> local pages</small>') || !renderedIndex.includes('Unverified preserved route')) {
