...
if (models.length !== 89 || localModels.length !== 86 || remoteModels.length !== 2 || unverifiedModels.length !== 1 || unverifiedModels[0]?.id !== 'xtts-v3') {
...
if (!renderedIndex.includes('86<small> local pages</small>') || !renderedIndex.includes('Unverified preserved route')) {
