...
if (models.length !== 76 || localModels.length !== 73 || remoteModels.length !== 2 || unverifiedModels.length !== 1 || unverifiedModels[0]?.id !== 'xtts-v3') {
...
if (!renderedIndex.includes('73<small> local pages</small>') || !renderedIndex.includes('Unverified preserved route')) {
