...
if (models.length !== 67 || localModels.length !== 64 || remoteModels.length !== 2 || unverifiedModels.length !== 1 || unverifiedModels[0]?.id !== 'xtts-v3') {
...
if (!renderedIndex.includes('64<small> local pages</small>') || !renderedIndex.includes('Unverified preserved route')) {
