...
if (models.length !== 60 || localModels.length !== 57 || remoteModels.length !== 2 || unverifiedModels.length !== 1 || unverifiedModels[0]?.id !== 'xtts-v3') {
...
if (!renderedIndex.includes('57<small> local pages</small>') || !renderedIndex.includes('Unverified preserved route')) {
