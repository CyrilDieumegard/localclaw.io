...
${hasRuntimeLaunchAssist ? `  ${runtimeLaunchAssistAsset}\n` : ''}  <script src="/js/model-ranking.js?v=20260820a"></script>
  <script src="/js/fit-context.js?v=20260905a"></script>
  ...
  <script src="/js/model-account-context-20260802b.js?v=20260905b"></script>
