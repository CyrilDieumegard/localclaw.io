...
for (const file of fs.readdirSync(out).filter(file => file.endsWith('.html'))) {
  ...
  const html = fs.readFileSync(filePath, 'utf8')
    ...
    .replace(/View current offers|View at Apple/g, 'Amazon buying options');
