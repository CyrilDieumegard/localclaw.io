...
const macs = [
  { id: 'mac-mini-m6-16gb', name: 'Mac mini M6 16GB', family: 'Mac mini', chip: 'M6', ram: 16, storage: '256GB SSD', badge: 'Pre-order · Sep 22', appleUrl: 'https://www.apple.com/mac-mini/', intent: 'next-generation entry local AI', preorder: true, available: 'September 22, 2026', price: '$899' },
  { id: 'mac-mini-m6-24gb', name: 'Mac mini M6 24GB', family: 'Mac mini', chip: 'M6', ram: 24, storage: '512GB SSD', badge: 'Pre-order · Sep 22', appleUrl: 'https://www.apple.com/mac-mini/', intent: 'a balanced compact local AI desktop', preorder: true, available: 'September 22, 2026', price: '$1,299' },
  { id: 'mac-mini-m6-32gb', name: 'Mac mini M6 32GB', family: 'Mac mini', chip: 'M6', ram: 32, storage: '512GB SSD', badge: 'Pre-order · Sep 22', appleUrl: 'https://www.apple.com/mac-mini/', intent: 'larger local models on a compact desktop', preorder: true, available: 'September 22, 2026' },
  { id: 'mac-mini-m5-pro-24gb', name: 'Mac mini M5 Pro 24GB', family: 'Mac mini', chip: 'M5 Pro', ram: 24, storage: '512GB SSD', badge: 'Pre-order · Sep 22', appleUrl: 'https://www.apple.com/mac-mini/', intent: 'compact local coding and reasoning workloads', preorder: true, available: 'September 22, 2026', price: '$1,699' },
  { id: 'mac-mini-m5-pro-64gb', name: 'Mac mini M5 Pro 64GB', family: 'Mac mini', chip: 'M5 Pro', ram: 64, storage: '1TB SSD', badge: 'Pre-order · Sep 22', appleUrl: 'https://www.apple.com/mac-mini/', intent: 'large local models on a compact Apple desktop', preorder: true, available: 'September 22, 2026' },
...
function page(mac, models) {
  ...
  const schema = { '@context': 'https://schema.org', '@type': 'TechArticle', headline: title, url, description: desc, dateModified: mac.preorder ? '2026-08-25' : '2026-08-18', image: `${BASE}${media.image}`, about: [mac.name, 'local LLM', 'Apple silicon'] };
