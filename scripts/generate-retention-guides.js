...
function nav(active = '') {
  return `<nav class="site-nav"><div class="nav-inner"><a href="/" class="logo"><span class="logo-box"><img src="/images/crab-logo.png" alt="LocalClaw logo" width="28" height="28"></span><span class="logo-text">Local<span>Claw</span></span></a><div class="nav-links"><a href="/">Home</a><a href="/llm-list.html" class="${active === 'llm' ? 'active' : ''}">LLM</a><a href="/tts-list.html" class="${active === 'tts' ? 'active' : ''}">TTS</a><a href="/computers.html">Computers</a><a href="/ram-gpu-for-local-ai.html">RAM/GPU</a><a href="/blog/">Blog</a><a href="/pricing.html" class="pricing">Pricing</a></div></div></nav>`;
}
