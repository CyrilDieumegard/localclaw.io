...
assert(index.includes('js/data.js?v=20260824a'), 'Homepage flow data cache key is stale');
assert(index.includes('js/app-20260816a.js?v=20260824a'), 'Homepage plan app cache key is stale');
