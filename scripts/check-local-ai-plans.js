...
assert(accountHtml.includes('/js/account-20260802a.js?v=20260905b'), 'Account plan script cache key is stale');
...
assert(index.includes('js/app-20260816a.js?v=20260905b'), 'Homepage plan app cache key is stale');
