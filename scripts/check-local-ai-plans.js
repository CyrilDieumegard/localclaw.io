...
assert(accountHtml.includes('/js/account-20260802a.js?v=20260905a'), 'Account plan script cache key is stale');
...
assert(index.includes('js/app-20260816a.js?v=20260905a'), 'Homepage plan app cache key is stale');
