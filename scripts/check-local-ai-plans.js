...
assert(accountHtml.includes('/js/account-20260802a.js?v=20260906a'), 'Account plan script cache key is stale');
...
assert(index.includes('js/data.js?v=20260906a'), 'Homepage flow data cache key is stale');
