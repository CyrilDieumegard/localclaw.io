...
# Generated for: macOS · 8GB RAM · Everything
...
echo -e "${CYAN}║  Optimized for: macOS · 8GB · Everything      ║${NC}"
echo -e "${CYAN}╚════════════════════════════════════════════════╝${NC}"
echo ""
...
echo -e "${YELLOW}[4/${TOTAL_STEPS}]${NC} Downloading GLM 4.7 Flash..."
...
echo -e "${YELLOW}  → Context window: 4096 tokens (optimized for 8GB RAM)${NC}"
